...
# confusion matrix
logr.prob <- predict(logr.fit,X_test_final)
logr.pred <-  ifelse(logr.prob >0.2, 1, 0)
confusionMatrix(factor(logr.pred,levels=0:1),factor(testing$Purchase,levels=0:1))
